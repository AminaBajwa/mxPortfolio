...
<div className="my-12 bg-[#03001417] backdrop-blur-md z-50">
  <div className="sm:max-w-7xl max-w-sm mx-auto">
    <div className="text-center">
      <h2 className="md:text-4xl text-3xl font-extrabold text-white mt-10">Meet our team</h2>
      <p className="mt-6 text-white">Meet our team of professionals to serve you.</p>
    </div>
    <div className="grid lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-2 gap-x-8 gap-y-20 text-center mt-32 mb-12">
