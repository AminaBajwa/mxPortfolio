...
const Cta = () => {
  ...
  <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
    <div className="max-w-2xl mx-auto text-center">
      ...
      <h2 className="mt-8 text-3xl font-bold leading-tight text-white lg:mt-12 sm:text-4xl lg:text-5xl">Join Our <span className="border-b-8 border-[#9615db]">vibrant developer</span> vibrant developer community</h2>
