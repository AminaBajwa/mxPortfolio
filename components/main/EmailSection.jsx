  ...
  return (
    ...
    <div className="flex flex-col lg:flex-row items-center lg:justify-center mx-auto mb-[100px] lg:max-w-5xl z-50">
      ...
      <div id="glob" className="flex flex-row justify-around absolute flex-wrap mt-14 gap-5 px-[330px] z-10 items-center">
        ...
        <h2 className="text-4xl text-white font-bold">Looking for a custom software development company?</h2>

        <p className="text-gary-400 mb-4 max-w-md text-white my-2">
      ...
      <div className="lg:w-full lg:mt-10">
        <form ref={form} onSubmit={sendEmail} className="p-8 rounded-lg shadow-md">
          <div className="mb-4">
            ...
            <input
              className="appearance-none border-2 rounded w-full py-2 px-4 text-white leading-tight focus:outline-none focus:border-[#1d4137] bg-[#18191E]"
              type="text"
              name="from_name"
            />
          </div>
          <div className="mb-4">
            ...
            <input
              className="appearance-none border-2 rounded w-full py-2 px-4 mb-1 leading-tight focus:outline-none focus:border-[#1d4137] bg-[#18191E] text-white"
              type="email"
              name="from_email"
            />
          </div>
          <div className="mb-6">
            ...
            <textarea
              className="appearance-none border-2 rounded w-full py-2 px-4 text-white mb-1 leading-tight focus:outline-none focus:border-[#1d4137] bg-[#18191E]"
              name="message"
              rows={5}
            />
          </div>
          <button
            className="shadow bg-[#1d4137] hover:bg-[#1d4137]-600 text-white font-medium focus:shadow-outline-purple focus:outline-none py-2 px-6 rounded"
            type="submit"
