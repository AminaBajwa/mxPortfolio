  ...
  <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
    <div className="grid grid-cols-2 md:col-span-3 lg:grid-cols-6 gap-y-16 gap-x-12">
      ...
      <div>
        ...
        <li>
          <Link href="/Technologies" className="flex text-base text-gray-400 transition-all duration-200 hover:text-[#9615DB] focus:text-[#9615DB]">Home</Link>
          </li>
          <li>
            <Link href="/About" className="flex text-base text-gray-400 transition-all duration-200 hover:text-[#9615DB] focus:text-[#9615DB]">About</Link>
          </li>
          <li>
          <Link href="/Industries" className="flex text-base text-gray-400 transition-all duration-200 hover:text-[#9615DB] focus:text-[#9615DB]">Industries</Link>
          </li>
          <li>
            <a href="/Contact_us"   className="flex text-base text-gray-400 transition-all duration-200 hover:text-[#9615DB] focus:text-[#9615DB]"> Contact </a>
          </li>
        </ul>
      </div>
      <div>
        <p className="text-sm font-semibold tracking-widest text-gray-200 uppercase">Community </p>
        <ul className="mt-6 space-y-4">
          <li>
      ...
      <div className="w-[300px]">
        ...
        <ul className="mt-6 space-y-4">
          <li>
            <Link href="/WebDev"   className="flex text-base text-gray-400 transition-all duration-200 hover:text-[#9615DB] focus:text-[#9615DB]"> Web Development </Link>
          </li>
          <li>
            <Link href="/MobDev"   className="flex text-base text-gray-400 transition-all duration-200 hover:text-[#9615DB] focus:text-[#9615DB]"> Mobile App Development </Link>
          </li>
          <li>
            <Link href="/DekstopApp"   className="flex text-base text-gray-400 transition-all duration-200 hover:text-[#9615DB] focus:text-[#9615DB]"> Desktop App Development </Link>
          </li>
          <li>
            <Link href="/GenAiDev"   className="flex text-base text-gray-400 transition-all duration-200 hover:text-[#9615DB] focus:text-[#9615DB]"> Generative Ai </Link>
          </li>
        </ul>
      </div>
